package hwweek08.encapsulation26;
...
public class Encapsulate {
    ...
    // set method for name to access private variabl name
    public void setName(String name) {
        this.name = name;
    }

    // get method for roll to access private variabl rollNo
    public int getRollNo() {
        return rollNo;
    }

    // set method for roll to access private variabl rollNo
